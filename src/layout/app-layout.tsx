...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'loan-officer', 'financial-advisor'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Advisors', path: '/advisors', entity: 'advisor', service: AccessServiceEnum.PROJECT, icon: FiPhoneCall },
    {
