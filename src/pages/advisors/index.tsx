...
import { useRoqClient, useAdvisorFindManyWithCount } from 'lib/roq';
...
export function AdvisorListPage(props: AdvisorListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['first_name.contains', 'last_name.contains', 'email.contains', 'phone.contains'],
          ...params.filters,
        },
        'advisor',
      ),
  ...
  const { data, error, isLoading, mutate } = useAdvisorFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.advisor.delete({ where: { id } });
      await mutate();
    } catch (error) {
