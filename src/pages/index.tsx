  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the Vehicle Financing Application, your one-stop solution for attractive vehicle loan schemes. Experience seamless financing like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1610647752706-3bb12232b3ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZWhpY2xlJTJCbG9hbnxlbnwwfHx8fDE2OTgzMjg0OTh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover the Vehicle Financing Application, your one-stop solution for attractive vehicle loan schemes. Experience seamless financing like never before.`}
            </Text>
            <Box
